...
🧬 达尔文进化框架 — 让任何AI资产自主进化、只保留改进 | 受Karpathy autoresearch启发
...
1. **克隆仓库**
```bash
git clone https://github.com/MoKangMedical/darwin-framework.git
cd darwin-framework
```
...
1. **构建镜像**
```bash
docker build -t darwin-framework .
```

2. **运行容器**
```bash
docker run -d -p 8000:8000 --name darwin-framework darwin-framework
```
...
- **项目主页**: https://github.com/MoKangMedical/darwin-framework
- **问题反馈**: https://github.com/MoKangMedical/darwin-framework/issues
